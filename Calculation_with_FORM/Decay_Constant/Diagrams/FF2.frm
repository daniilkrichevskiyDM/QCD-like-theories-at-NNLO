...
G FF2x`ext1'`ext2'`SX4' =  i_*SymmetryFactorDecay2*(
  vertex`diagram'`SX4'
 );
...
#call pickout(`ext1',p1ext,p,pp,2,FF2x`ext1'`ext2'`SX4')
#call pickoutA(`ext2',p2ext,Pol1,p,pp,v,vvv,2,FF2x`ext1'`ext2'`SX4')
...
Print FF2x`ext1'`ext2'`SX4';
.store
save save/FF2_`ext1'`ext2'`SX4'.sav 
   FF2x`ext1'`ext2'`SX4';
.end
