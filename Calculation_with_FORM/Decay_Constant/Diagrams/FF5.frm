*diagram FF5 from 2 4-point LO interactions
*                             
*              / \ RR             
*              \ /              
*               x             
...
G FF5x`ext1'`ext2'`SX4'Upper = vertex`diagram1'`SX4';
G FF5x`ext1'`ext2'`SX4'Lower = vertex`diagram2'`SX4';
...
skip; 
nskip FF5x`ext1'`ext2'`SX4'Upper;
#call setmom(q,4)
.sort

skip; 
nskip FF5x`ext1'`ext2'`SX4'Lower;
#call setmom(p,4)
#call setpol(v,1)
.sort 
...
#call connectbubble(QQ,q,qq,4,FF5x`ext1'`ext2'`SX4'Upper)

*2) Now we do 2 pickouts for the lower diagram 
#call pickout(`ext1',p1ext,p,pp,4,FF5x`ext1'`ext2'`SX4'Lower)
#call pickoutA(`ext2',p2ext,Pol1,p,pp,v,vvv,2,FF5x`ext1'`ext2'`SX4'Lower)
...
G product = SymmetryFactorDecay5 * ComplexUnitFactor * FF5x`ext1'`ext2'`SX4'Upper *  FF5x`ext1'`ext2'`SX4'Lower;
...
.store
save save/FF5_`ext1'`ext2'`SX4'.sav 
   FF5x`ext1'`ext2'`SX4';
