...
symbol L0r,L1r,L2r,L3r,L4r,L5r,L6r,L7r,L8r,L9r,L10r, H2r, rmq;
...
#include HansVacuum.hf

G differenceNLO =  CondensateNLO - S`ext1'p4`SX4';
G differenceNNLO = (CondensateNNLO  - S`ext1'p6`SX4')/(F^-2*B0);
G NNLONorm = (CondensateNNLO)/(F^-2*B0);
.sort
...
Print differenceNLO, differenceNNLO ;
