...
G MM1x`ext1'`ext2'`SX4'Hans =  i_*(
  vertex2Mp2`SX4'
 );
#call setmom(p,4)
#include takederiv.hf
.sort
#call pickout(`ext1',p1ext,p,pp,2,MM1x`ext1'`ext2'`SX4'Hans)
#call pickout(`ext2',p2ext,p,pp,2,MM1x`ext1'`ext2'`SX4'Hans)
id p2ext = -p1ext;
.sort
