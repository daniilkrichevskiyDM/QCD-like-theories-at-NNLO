...
G MM5x`ext1'`ext2'`SX4'`diagram'Upper = vertex`diagram'`SX4';
G MM5x`ext1'`ext2'`SX4'`diagram'Lower = vertex`diagram'`SX4';
...
skip; 
nskip MM5x`ext1'`ext2'`SX4'`diagram'Upper;
#call setmom(q,4)
.sort

skip; 
nskip MM5x`ext1'`ext2'`SX4'`diagram'Lower;
#call setmom(p,4)
.sort 
...
#call connectbubble(QQ,q,qq,4,MM5x`ext1'`ext2'`SX4'`diagram'Upper)

*2) Now we do 2 pickouts for the lower diagram 
#call pickout(`ext1',p1ext,p,pp,4,MM5x`ext1'`ext2'`SX4'`diagram'Lower)
#call pickout(`ext2',p2ext,p,pp,3,MM5x`ext1'`ext2'`SX4'`diagram'Lower)
...
G product = SymmetryMM5 * ComplexUnitFactor * MM5x`ext1'`ext2'`SX4'`diagram'Upper *  MM5x`ext1'`ext2'`SX4'`diagram'Lower;
...
G MM5x`ext1'`ext2'`SX4'`diagram' = product;
...
.store
save save/MM5_`ext1'`ext2'`SX4'`diagram'.sav 
   MM5x`ext1'`ext2'`SX4'`diagram';
