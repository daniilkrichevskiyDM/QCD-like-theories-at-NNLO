...
*
.sort
#message Procedure gauss4 dealing with complexity `c'
*
...
*
    ...
    #endinside
    #usedictionary LHS($)
      #write <reduceT1.prc> "id,ifmatch->looplabel,%2$",$lhs
    #closedictionary
    #write <reduceT1.prc> "  =%2$;",$xxx
    #endif
    .sort
*
